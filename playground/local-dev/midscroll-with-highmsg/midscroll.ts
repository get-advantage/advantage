async function initHighImpactJsMessage() {
    console.log("Midscroll with original High Impact JS message script loaded");
    ...
    setTimeout(() => {
        ...
        console.log(
            "Sending original High Impact JS message (Midscroll):",
            message
        );
